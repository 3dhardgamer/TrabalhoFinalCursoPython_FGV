...
There is a quick data inspection to verify data range, followed by the data visualisation.# Trabalho Final Curso Python FGV
=======
>>>>>>> e1e41a3a15de16be46febd10f5e09df4a266dc90
This repository is intended to keep the final assessment of FGV's Python Summer Course (Jan/2018).
